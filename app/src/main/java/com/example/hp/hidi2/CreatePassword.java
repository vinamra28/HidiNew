...
public class CreatePassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        constraintLayout = findViewById(R.id.createpswd);
            ...
            try {
                ...
                if (info.getString("status").equals("success")) {
                    ...
                    if (olddd.length() != 0) {
                        ...
                        hit.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (Pattern.matches("(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%*])(?=\\S+$).{8,16}", oldps)) {
                                    ...
                                    Snackbar snackbar = Snackbar.make(constraintLayout, "Password must contain one alphabet(CAPITAL and small) one number and a special character of length greater than 8", Snackbar.LENGTH_LONG);
                                    snackbar.show();
                                }
                            }
                        });
                        ...
                        old.setVisibility(View.INVISIBLE);
                        oness.setVisibility(View.INVISIBLE);
                        newp.setVisibility(View.VISIBLE);
                        cnfrm.setVisibility(View.VISIBLE);
                        hit.setText("Create");
                        hit.setVisibility(View.VISIBLE);
                        hit.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (Pattern.matches("(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%*])(?=\\S+$).{8,16}", newps)) {
                                    ...
                                    Snackbar snackbar = Snackbar.make(constraintLayout, "Password must contain atleast an alphabet(CAPITAL and small),number & a special character ", Snackbar.LENGTH_LONG);
                                    snackbar.show();
                                }
                            }
                        });
